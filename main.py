...
parser.add_argument('-t','--typesearch', type=str, help='Type of search(Input: title, year, director, genre, etc.')
parser.add_argument('-m','--match', type=str, help='Type of search must match(Input: hobbit, 2016, Peter Jackson, Action, etc')
